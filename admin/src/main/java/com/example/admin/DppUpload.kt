...
import kotlinx.android.synthetic.main.activity_dpp_upload.*

class DppUpload : AppCompatActivity() {
    lateinit var firestore: FirebaseFirestore
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dpp_upload)
    ...
    private fun submitQuestion() {
        ...
        val case1:String=intent.getStringExtra("type").toString()
        val case2:String=intent.getStringExtra("type").toString()
        val case3:String=intent.getStringExtra("type").toString()
