...
import kotlinx.android.synthetic.main.activity_pdf_upload.*
import java.io.File
...
//            intent.addCategory(Intent.CATEGORY_DEFAULT)
    ...
    private fun processUpload(uri: Uri) {
        val case1 =intent.getStringExtra("type").toString()
        val case2 =intent.getStringExtra("type").toString()
        val case3 =intent.getStringExtra("type").toString()
        val case4 =intent.getStringExtra("type").toString()
        val case5 =intent.getStringExtra("type").toString()
        val case6 =intent.getStringExtra("type").toString()
        val case7 =intent.getStringExtra("type").toString()
        val case8 =intent.getStringExtra("type").toString()
        val case9 =intent.getStringExtra("type").toString()
        val case10 =intent.getStringExtra("type").toString()
        val case11 =intent.getStringExtra("type").toString()
        val case12 =intent.getStringExtra("type").toString()
